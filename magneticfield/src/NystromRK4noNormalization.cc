...
NystromRK4noNormalization::NystromRK4noNormalization(G4Mag_EqRhs* magEqRhs, G4double distanceConstField)
...
NystromRK4noNormalization::~NystromRK4noNormalization()
{
}
...
void
NystromRK4noNormalization::Stepper
(const G4double P[],const G4double dPdS[],G4double Step,G4double Po[],G4double Err[])
{
  ...
  // Temporary testing adjustments
  m_imom = 1.; // no nomalization in this version of NystromRK4
  m_cof = 1.;  // taken care of in call to Mag_UsualEqRhs_IntegrateByTime::ComputeRhsGivenB()
...
G4double
NystromRK4noNormalization::DistChord() const
{
...
/*
void
NystromRK4noNormalization::ComputeRightHandSide(const G4double P[],G4double dPdS[])
{
