...
// ********************************************************************
//
// $Id: NTSTGunGenerator.hh,v 1.2 2007-10-26 09:51:29 gcosmo Exp $
...
public:
  ...
  virtual void SetPlow        (G4double m)      { Plow  = m; }
  virtual void SetPhigh       (G4double m)      { Phigh = m; }
  virtual void SetCoslow      (G4double m)      { Coslow  = m; }
  virtual void SetCoshigh     (G4double m)      { Coshigh = m; }
  virtual void SetPhilow      (G4double m)      { Philow  = m; }
  virtual void SetPhihigh     (G4double m)      { Phihigh = m; }
  ...
  virtual void SetT0          (G4double t)      { T0=t; }
  virtual void SetNumberOfParticles   (G4int n) { N=n; }
