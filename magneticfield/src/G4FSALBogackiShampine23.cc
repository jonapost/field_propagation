...
// ********************************************************************
//
//  Bogacki-Shampine 4-stage 3(2) non-FSAL implementation by Somnath Banerjee
...
This contains the stepper function of the G4FSALBogackiShampine23class
...
//Constructor
G4FSALBogackiShampine23::G4FSALBogackiShampine23(G4EquationOfMotion *EqRhs,
    ...
    fLastStepLength(0.), fAuxStepper(0)
{
  ...
  if( primary )
  {
    fAuxStepper = new G4FSALBogackiShampine23(EqRhs, numberOfVariables, !primary);
  }
}


//Destructor
G4FSALBogackiShampine23::~G4FSALBogackiShampine23()
{
  delete[] ak2;
  delete[] ak3;
  delete[] ak4;
...
void
G4FSALBogackiShampine23::Stepper( const G4double yInput[],
                          const G4double dydx[],
                                  G4double Step,
                                  G4double yOut[],
                                  G4double yErr[],
...
G4double  G4FSALBogackiShampine23::DistChord() const
{
