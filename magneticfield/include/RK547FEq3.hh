...
class RK547FEq3 : public G4MagIntegratorStepper {
public:
    RK547FEq3(G4EquationOfMotion* EqRhs, G4int integrationVariables = 6);
    ...
    RK547FEq3(const RK547FEq3&) = delete;
    RK547FEq3& operator = (const RK547FEq3&) = delete;
