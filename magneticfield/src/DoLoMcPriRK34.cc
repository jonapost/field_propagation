...
//
//
//    This is the source file of DoLoMcPriRK34 class containing the
...
//Constructor
DoLoMcPriRK34::DoLoMcPriRK34(G4EquationOfMotion *EqRhs,
...
: G4MagIntegratorStepper(EqRhs, noIntegrationVariables){
   ...
   if( primary )
   {
       fAuxStepper = new DoLoMcPriRK34(EqRhs, numberOfVariables,
                                          !primary);
   }
}
...
void DoLoMcPriRK34::Stepper(const G4double yInput[],
                          const G4double DyDx[],
                          	    G4double Step,
                            	G4double yOut[],
                              	G4double yErr[] )
...
G4double  DoLoMcPriRK34::DistChord() const
{
...
void DoLoMcPriRK34::SetupInterpolate( const G4double yInput[],
                                     const G4double dydx[],
                                     const G4double Step ){
    //Do Nothing
}
...
void DoLoMcPriRK34::Interpolate( const G4double yInput[],
                                const G4double dydx[],
                                const G4double Step,
                                G4double yOut[],
                                G4double tau ){
