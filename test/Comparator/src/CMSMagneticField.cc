...
CMSMagneticField::CMSMagneticField(std::string inputMap)
{
...
void CMSMagneticField::ReadVectorData(string inputMap)
{
    string line;
...
void CMSMagneticField::GetFieldValueRZ(const double r, const double Z, G4ThreeVector &rzField) const
{
...
void CMSMagneticField::GetFieldValueXYZ(const G4ThreeVector &pos, G4ThreeVector &xyzField) const
{
...
void CMSMagneticField::GetFieldValueTest(const G4ThreeVector &pos, G4ThreeVector &rzField)
{
    double cyl[2];
    CartesianToCylindrical(pos, cyl); 
...
void CMSMagneticField::GetFieldValueRZ(const std::vector<double>   & radius,
...
/***
void CMSMagneticField::GetFieldValues(const vecgeom::SOA3D<double> &posVec,
