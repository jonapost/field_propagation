...
//
//
// $Id: F02RunAction.cc 66241 2012-12-13 18:34:42Z gunter $
//
// 
...
void F02RunAction::FillNbOfSteps(G4double ns)
{
#ifndef G4NOHIST
...
void F02RunAction::FillEn(G4double En)
{
#ifndef G4NOHIST
  G4double bin ;
  G4int ibin;
...
void F02RunAction::FillTt(G4double En)
{
#ifndef G4NOHIST
  G4double bin ;
  G4int ibin;
...
void F02RunAction::FillTb(G4double En)
{
#ifndef G4NOHIST
  G4double bin ;
  G4int ibin;
...
void F02RunAction::FillTsec(G4double En)
{
#ifndef G4NOHIST
  G4double bin ;
  G4int ibin;
...
void F02RunAction::FillTh(G4double Th)
{
#ifndef G4NOHIST
...
void F02RunAction::FillThBack(G4double Th)
{
#ifndef G4NOHIST
...
void F02RunAction::FillR(G4double R )
{
#ifndef G4NOHIST
  G4double bin ;
  G4int ibin;
...
void F02RunAction::Fillvertexz(G4double z )
{
#ifndef G4NOHIST
  G4double bin ;
  G4int ibin;
...
void F02RunAction::SethistName(G4String name)
{
  histName = name ;
  G4cout << " hist file = " << histName << G4endl;
}

void F02RunAction::SetnbinStep(G4int nbin)
{
  nbinStep = nbin ;
  if(nbinStep>0)
...
void F02RunAction::SetSteplow(G4double low)
{
  Steplow = low ;
  if(nbinStep>0)
  G4cout << " low  in the #step plot = " << Steplow << G4endl ;
}
void F02RunAction::SetStephigh(G4double high)
{
  Stephigh = high ;
  if(nbinStep>0)
...
void F02RunAction::SetnbinEn(G4int nbin)
{
  nbinEn = nbin ;
...
void F02RunAction::SetEnlow(G4double Elow)
{
  Enlow = Elow ;
  if(nbinEn>0) G4cout << " Elow  in the  Edep plot = " << Enlow << G4endl ;
}

void F02RunAction::SetEnhigh(G4double Ehigh)
{
  Enhigh = Ehigh ;
...
void F02RunAction::SetnbinGamma(G4int nbin)
{
  nbinGamma = nbin ;
  if(nbinGamma>0)
...
void F02RunAction::SetElowGamma(G4double Elow)
{
  ElowGamma = Elow ;
  if(nbinGamma>0)
...
void F02RunAction::SetEhighGamma(G4double Ehigh)
{
  EhighGamma = Ehigh ;
  if(nbinGamma>0)
...
void F02RunAction::SetnbinTt(G4int nbin)
{
  nbinTt = nbin ;
  if(nbinTt>0)
...
void F02RunAction::SetTtlow(G4double Elow)
{
  Ttlow = Elow ;
  if(nbinTt>0)
...
void F02RunAction::SetTthigh(G4double Ehigh)
{
  Tthigh = Ehigh ;
  if(nbinTt>0)
...
void F02RunAction::SetnbinTb(G4int nbin)
{
  nbinTb = nbin ;
  if(nbinTb>0)
...
void F02RunAction::SetTblow(G4double Elow)
{
  Tblow = Elow ;
  if(nbinTb>0)
...
void F02RunAction::SetTbhigh(G4double Ehigh)
{
  Tbhigh = Ehigh ;
  if(nbinTb>0)
...
void F02RunAction::SetnbinTsec(G4int nbin)
{
  nbinTsec = nbin ;
  if(nbinTsec>0)
...
void F02RunAction::SetTseclow(G4double Elow)
{
  Tseclow = Elow ;
  if(nbinTsec>0)
...
void F02RunAction::SetTsechigh(G4double Ehigh)
{
  Tsechigh = Ehigh ;
  if(nbinTsec>0)
...
void F02RunAction::SetRlow(G4double rlow)
{
  Rlow = rlow ;
  if(nbinR>0)
...
void F02RunAction::SetRhigh(G4double rhigh)
{
  Rhigh = rhigh ;
  if(nbinR>0)
...
void F02RunAction::Setnbinzvertex(G4int nbin)
{
  nbinvertexz  = nbin ;
  if(nbinvertexz>0)
...
void F02RunAction::Setzlow(G4double z)
{
  zlow = z ;
  if(nbinvertexz>0)
...
void F02RunAction::Setzhigh(G4double z)
{
  zhigh = z ;
  if(nbinvertexz>0)
...
void F02RunAction::SetnbinTh(G4int nbin)
{
  nbinTh = nbin ;
  if(nbinTh>0)
...
void F02RunAction::SetThlow(G4double Tlow)
{
  Thlow = Tlow ;
  if(nbinTh>0)
...
void F02RunAction::SetThhigh(G4double Thigh)
{
  Thhigh = Thigh ;
  if(nbinTh>0)
...
void F02RunAction::SetnbinThBack(G4int nbin)
{
  nbinThback = nbin ;
  if(nbinThback>0)
...
void F02RunAction::SetThlowBack(G4double Tlow)
{
  Thlowback = Tlow ;
  if(nbinThback>0)
...
void F02RunAction::SetThhighBack(G4double Thigh)
{
  Thhighback = Thigh ;
  if(nbinThback>0)
