...
BSChordFinder::BSChordFinder(BulirschStoerDriver *BSDriver)   // (BaseDriver *BSDriver)
...
void
BSChordFinder::SetFractions_Last_Next( G4double fractLast, G4double fractNext )
{
  ...
  {
    G4cerr << "BSChordFinder::SetFractions_Last_Next: Invalid "
...
G4double
BSChordFinder::AdvanceChordLimited( G4FieldTrack& yCurrent,
                                    G4double      stepMax,
                                    G4double      epsStep,
...
G4double
BSChordFinder::FindNextChord( const  G4FieldTrack& yStart,
                                     G4double     stepMax,
                                        ...
                                        )
{
  ...
  if( noTrials >= maxTrials )
  {
      ...
      message << "Exceeded maximum number of trials= " << maxTrials << G4endl
              ...
              ;
      G4Exception("BSChordFinder::FindNextChord()", "GeomField0003",
                  JustWarning, message);
  }
...
G4double BSChordFinder::NewStep(G4double  stepTrialOld,
...
G4FieldTrack
BSChordFinder::ApproxCurvePointS( const G4FieldTrack&  CurveA_PointVelocity,
                                       ...
                                       G4bool first, G4double eps_step)
{
  ...
  else
  {
    ...
    //
    G4cout << "BSChordFinder::ApproxCurvePointS() - test-step ShF = "
    ...
    TestTrack = ApproxCurvePointV( CurveA_PointVelocity,
                                   ...
                                   CurrentE_Point, eps_step );
    G4cout.precision(14);
    G4cout << "BSChordFinder::BrentApprox = " << EndPoint  << G4endl;
    G4cout << "BSChordFinder::LinearApprox= " << TestTrack << G4endl;
#endif
  }
  return EndPoint;
}
                         ...
                         G4double eps_step)
{
  ...
  {
#ifdef G4DEBUG_FIELD
    G4cerr << " Warning in BSChordFinder::ApproxCurvePoint: "
           << G4endl
    ...
    if( curve_length < ABdist * (1. - 10*eps_step) )
    {
      ...
      message << "Unphysical curve length." << G4endl
              ...
              << G4endl
              << "Aborting.";
      G4Exception("BSChordFinder::ApproxCurvePointV()", "GeomField0003",
...
#ifdef G4DEBUG_FIELD
     G4cout << "Warning in BSChordFinder::ApproxCurvePointV():"
  ...
  {
#ifdef G4DEBUG_FIELD
    G4cerr << " BSChordFinder::ApproxCurvePointV() - Warning:"
...
void
BSChordFinder::PrintStatistics()
{
  // Print Statistics

  G4cout << "BSChordFinder statistics report: " << G4endl;
  G4cout
...
void BSChordFinder::TestChordPrint( G4int    noTrials,
                                    G4int    lastStepTrial,
                                    G4double dChordStep,
