#ifndef CMS_MAGNETIC_FIELD_HH
#define CMS_MAGNETIC_FIELD_HH
...
public:
    CMSMagneticField(std::string inputMap);
     ~CMSMagneticField();
...
inline void CMSMagneticField::CartesianToCylindrical(const G4ThreeVector &cart, double cyl[2]) const
{
    //cyl[3] =[r,z,phi]
...
inline
void
CMSMagneticField::CylindricalToCartesian(const G4ThreeVector &rzField,
...
inline void
CMSMagneticField::GetFieldValue( const G4double  Point[4],
