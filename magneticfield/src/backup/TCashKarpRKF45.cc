...
template
	...
	TCashKarpRKF45<T_Equation, T_Field>::TCashKarpRKF45(T_Equation *EqRhs,
...
template
	<class T_Equation, class T_Field>
TCashKarpRKF45<T_Equation, T_Field>::~TCashKarpRKF45()
{
	delete[] ak2;
	delete[] ak3;
	delete[] ak4;
...
template
	<class T_Equation, class T_Field>
void TCashKarpRKF45<T_Equation, T_Field>::Stepper(const G4double yInput[],
		const G4double dydx[],
		G4double Step,
		G4double yOut[],
		G4double yErr[])
...
template
<class T_Equation, class T_Field>
G4double  TCashKarpRKF45<T_Equation, T_Field>::DistChord() const
{
