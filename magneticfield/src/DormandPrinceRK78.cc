...
//Constructor
DormandPrinceRK78::DormandPrinceRK78(G4EquationOfMotion *EqRhs,
...
: G4MagIntegratorStepper(EqRhs, noIntegrationVariables){
    ...
    if( primary )
    {
        fAuxStepper = new DormandPrinceRK78(EqRhs, numberOfVariables,
                                            !primary);
    }
}
...
//Destructor
DormandPrinceRK78::~DormandPrinceRK78(){
