...
{  
  ...
  //G4cout<<"eps: "<<epsilon<<" epsMin: "<<epsilonMin<<G4endl;
  ...
  { 
    ...
    //G4cout<<"s_length_taken: "<<s_length_taken<<G4endl;
    ...
    if( intersects )
    {
       ...
       G4bool found_intersection = fIntersectionLocator->
         EstimateIntersectionPoint( SubStepStartState, CurrentState, 
                                    ...
                                    fPreviousSftOrigin);
       //G4cout<<"end call locator \n";
       intersects = found_intersection;
       if( found_intersection )
       {
          //G4cout<<"intersection found ! \n";
          ...
          //G4cout<<"StepTaken: "<<StepTaken<<G4endl;
       }
       else
       {
           //G4cout<<"intersection not found ! \n";
...
G4int G4PropagatorInField::SetVerboseLevel( G4int level )
{
  ...
  // MagIntegratorDriver ... ? 
  //
  GetChordFinder()->SetVerbose( fVerboseLevel - 2 );
