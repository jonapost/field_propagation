...
//
//
// $Id: G4ChordFinderOld.cc 97812 2016-06-14 07:57:41Z gcosmo $
//
//
...
G4ChordFinderOld::G4ChordFinderOld(G4MagInt_Driver* pIntegrationDriver)
...
G4ChordFinderOld::G4ChordFinderOld( G4MagneticField*        theMagField,
...
G4ChordFinderOld::~G4ChordFinderOld()
{
...
void   
G4ChordFinderOld::SetFractions_Last_Next( G4double fractLast, G4double fractNext )
{ 
  ...
  {
    G4cerr << "G4ChordFinderOld::SetFractions_Last_Next: Invalid "
...
G4double 
G4ChordFinderOld::AdvanceChordLimited( G4FieldTrack& yCurrent,
                                    G4double      stepMax,
                                    G4double      epsStep,
...
G4double
G4ChordFinderOld::FindNextChord( const  G4FieldTrack& yStart,
                                     G4double     stepMax,
                                        ...
                                        )
{
  ...
  if( noTrials >= maxTrials )
  {
      ...
      message << "Exceeded maximum number of trials= " << maxTrials << G4endl
              ...
              ;
      G4Exception("G4ChordFinderOld::FindNextChord()", "GeomField0003",
                  JustWarning, message);
  }
...
G4double G4ChordFinderOld::NewStep(G4double  stepTrialOld, 
...
G4FieldTrack
G4ChordFinderOld::ApproxCurvePointS( const G4FieldTrack&  CurveA_PointVelocity, 
                                       ...
                                       G4bool first, G4double eps_step)
{
  ...
  else
  {
    ...
    //
    G4cout << "G4ChordFinderOld::ApproxCurvePointS() - test-step ShF = "
    ...
    TestTrack = ApproxCurvePointV( CurveA_PointVelocity, 
                                   ...
                                   CurrentE_Point, eps_step );
    G4cout.precision(14);
    G4cout << "G4ChordFinderOld::BrentApprox = " << EndPoint  << G4endl;
    G4cout << "G4ChordFinderOld::LinearApprox= " << TestTrack << G4endl; 
#endif
  }
  return EndPoint;
}
                         ...
                         G4double eps_step)
{
  ...
  { 
#ifdef G4DEBUG_FIELD
    G4cerr << " Warning in G4ChordFinderOld::ApproxCurvePoint: "
           << G4endl
    ...
    if( curve_length < ABdist * (1. - 10*eps_step) )
    {
      ...
      message << "Unphysical curve length." << G4endl
              ...
              << G4endl
              << "Aborting.";
      G4Exception("G4ChordFinderOld::ApproxCurvePointV()", "GeomField0003",
...
#ifdef G4DEBUG_FIELD
     G4cout << "Warning in G4ChordFinderOld::ApproxCurvePointV():"
  ...
  {
#ifdef G4DEBUG_FIELD
    G4cerr << " G4ChordFinderOld::ApproxCurvePointV() - Warning:"
...
void
G4ChordFinderOld::PrintStatistics()
{
  // Print Statistics

  G4cout << "G4ChordFinderOld statistics report: " << G4endl;
  G4cout 
...
void G4ChordFinderOld::TestChordPrint( G4int    noTrials, 
                                    G4int    lastStepTrial, 
                                    G4double dChordStep, 
