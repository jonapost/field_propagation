...
RK547FEq2::RK547FEq2(G4EquationOfMotion *EqRhs, G4int integrationVariables)
   : G4MagIntegratorStepper(EqRhs, integrationVariables)
{
}

void RK547FEq2::makeStep(
...
G4double RK547FEq2::DistChord() const
{
