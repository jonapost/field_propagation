...
//
//
// $Id: BuildBoxWorld.hh,v 1.1 2007-10-11 13:01:08 gcosmo Exp $
...
G4VPhysicalVolume* BuildBoxWorld()
{
    ...
    G4Box *myTargetBox = new G4Box ("TBox",100*CLHEP::mm,200*CLHEP::mm,400*CLHEP::mm);
    //G4Cons *myTargetBox = new G4Cons ("TBox",100*CLHEP::mm,200*CLHEP::mm,400*CLHEP::mm,600*CLHEP::mm,200*CLHEP::mm,0,2*CLHEP::pi);
    ...
    new G4PVPlacement(0,G4ThreeVector(10*CLHEP::mm,10*CLHEP::mm,10*CLHEP::mm),
		      "TPhys",
		      myTargetLog,
		      myWorldPhys,false,0);
