...
//
//
// $Id: G4MagIntegratorDriver.cc 105011 2017-07-04 11:26:02Z japost $
//
// 
//
                                        ...
                                        const G4double errorTolerance)
{
    ...
    G4double positionError2 =  getValue2(yerr, Value3D::Position);
    ...
    if (momentum2 > 0) {
        momentumError2 = getValue2(yerr, Value3D::Momentum);
    ...
    if (spin2 > 0) {
        spinError2 = getValue2(yerr, Value3D::Spin);
