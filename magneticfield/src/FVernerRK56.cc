//  FVerner's RK 6(5) non-FSAL implementation by Somnath Banerjee
...
/**************************************************************************
     ...
     The following code uses the work of J.H.FVerner, obtained from
...
: G4MagIntegratorStepper(EqRhs, noIntegrationVariables){
    ...
    if( primary )
    {
        fAuxStepper = new FVernerRK56(EqRhs, numberOfVariables,
                                     !primary);
    }
}
...
void FVernerRK56::Stepper( const G4double yInput[],
                           const G4double dydx[],
                                 G4double Step,
                                 G4double yOut[],
                                 G4double yErr[],
...
G4double  FVernerRK56::DistChord() const
{
...
void FVernerRK56::interpolate( const G4double yInput[],
                             const G4double dydx[],
                             G4double yOut[],
                             G4double Step,
                             G4double tau
...
void FVernerRK56::interpolate6( const G4double yInput[],
                             const G4double dydx[],
                             G4double yOut[],
                             G4double Step,
                             G4double tau
