...
//
//  Tsitouras - 5(4) non-FSAL implementation by Somnath Banerjee
...
FTsitourasRK45::FTsitourasRK45(G4EquationOfMotion *EqRhs,
...
fLastStepLength(0.), fAuxStepper(0)
{
    ...
    if( primary )
    {
        fAuxStepper = new FTsitourasRK45(EqRhs, numberOfVariables, !primary);
    }
}
...
// Doing a step
void
FTsitourasRK45::Stepper(const G4double yInput[],
                        const G4double dydx[],
                        G4double Step,
                        G4double yOut[],
                        G4double yErr[],
                        G4double nextDydx[] )
{
    ...
    //    dc1 = 0.001780011052226 ,//- b71,
    //    dc2 = 0.000816434459657 ,//- b72,
    //    dc3 = -0.007880878010262 ,//- b73,
    //    dc4 = 0.144711007173263 ,//- b74,
    //    dc5 = -0.582357165452555 ,//- b75,
    //    dc6 = 0.458082105929187 ,//- b76,
    //    dc7 = 1.0/66.0 ;
    
    //
    //    dc1 = b71 - 0.0935237485818927066,//b71 - 0.001780011052226,
    //    dc2 = b72 - 0.00865288314156636761,//b72 - 0.000816434459657,
    //    dc3 = b73 - 0.492893099131431868,//b73 + 0.007880878010262,
    //    dc4 = b74 - 1.14023541226785810,//b74 - 0.144711007173263,
    //    dc5 = b75 + 2.3291801924393646,//b75 + 0.582357165452555,
    //    dc6 = b76 - 1.56887504931661552,//b76 - 0.458082105929187,
    //    dc7 = 0.025;//- 1.0/66.0 ;
    ...
    RightHandSide(yOut, ak7);       //7th and Final Stage
    								//Also the FSAL propagated stage
...
void FTsitourasRK45::interpolate(  const G4double yInput[],
                                const G4double dydx[],
                                G4double yOut[],
                                G4double Step,
                                G4double tau){
...
G4double  FTsitourasRK45::DistChord() const
{
    ...
    fAuxStepper->Stepper( fLastInitialVector, fLastDyDx, 0.5 * fLastStepLength,
                         fMidVector,   fMidError, fake_Next_Dydx );
