...
//  History
// -----------------------------
//  Created by Somnath on 25 May 2015
//
//
///////////////////////////////////////////////////////////////////////////////
//
...
//
// The code has been adapted from rksuite.f : http://www.netlib.org/ode/rksuite/
...
void BogackiShampine45::SetupInterpolate_high(const G4double *yInput, const G4double *dydx, const G4double Step){
...
void BogackiShampine45::Interpolate_high(const G4double *yInput, const G4double *dydx, const G4double Step, G4double *yOut, G4double tau){
    
    G4double bi[12][7], b[12];
...
//	The scheme tries to do the same as the DormandPrinnce745 routine, but fails
