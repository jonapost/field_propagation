...
* G4NystromRK4noNormalization.h
 *
 *  Created on: Jun 14, 2015
 *      Author: jason
 */

#ifndef MAGNETICFIELD_INCLUDE_G4NYSTROMRK4NONORMALIZATION_H_
#define MAGNETICFIELD_INCLUDE_G4NYSTROMRK4NONORMALIZATION_H_
...
class NystromRK4noNormalization : public G4MagIntegratorStepper
{
  public:
   NystromRK4noNormalization(G4Mag_EqRhs *EquationMotion, G4double distanceConstField=0.0);
      // Can be used only for Magnetic Fields - and for 6 variables (x,p)

    ~NystromRK4noNormalization() ;
    ...
    // Not overridden in this test class.
...
// Inline methods
/////////////////////////////////////////////////////////////////////////////////
inline void  NystromRK4noNormalization::SetDistanceForConstantField( G4double length )
{
  m_magdistance=   length;
  m_magdistance2 = length*length;
}

inline G4double  NystromRK4noNormalization::GetDistanceForConstantField() const
{
...
inline void NystromRK4noNormalization::getField (const G4double P[4])
{
...
#endif  // MAGNETICFIELD_INCLUDE_G4NYSTROMRK4NONORMALIZATION_H_
